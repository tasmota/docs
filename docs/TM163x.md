# TM1637 and TM1638 Seven-Segment Display
<br>
...
| TM1637   | TM1638 |
|---|---|
|<br>![TM1637](_media/peripherals/TM1637-front.png)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;    | <br>![TM1638](_media/peripherals/TM1638-front.png)   |

   
<br><br>

The **TM1637** and **TM1638** display modules are small (~ 10mm high digits) 7-segment, LED-based display units with 4/6 digits (TM1637) and 8 digits (TM1638) respectively. They use a two-wire (TM1637) or three-wire (TM1638) I2C-like (but not exactly) protocol for communication with MCUs like the ESP8266 / ESP32 / Arduino etc., 
...
The **TM1638** module needs to be connected to three GPIO pins and a 3.3V-5V power supply.  
<br>
