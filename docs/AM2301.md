...
**NOTE: Sonoff AM2301 v1.0 (green PCB) currently does not work with Tasmota (or any other open source firmware).  ITEAD have replaced the AM2301 with an MCU to emulate the functionality.  Only the original green PCB version works.  [Issue 8516](https://github.com/arendst/Tasmota/issues/8516)**
