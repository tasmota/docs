...
- `tasmota-ir` is pre-packaged on IR Bridges by [Automate Things](https://templates.blakadder.com/automate_things_AT-IRBR_v14.html), [Eachen](https://templates.blakadder.com/eachen-IR-DC6.html) or [YTF](https://templates.blakadder.com/ytf_ir_bridge.html). Choose `tasmota-ir` if you are using an IR blaster. 
