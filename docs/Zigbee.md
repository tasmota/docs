...
Follow the usual ESP82xx [flashing process](installation/Flashing.md) - you are just using [`CCLib_proxy.ino.bin`](https://github.com/s-hadinger/CCLib/blob/master/Bin/CCLib_proxy.ino.bin) instead of Tasmota.
...
- Flashing with [CCLoader using a NodeMCU/Wemos D1 Mini](https://zigbee.blakadder.com/flashing_ccloader.html)
...
- Follow the usual [Tasmota flashing process](installation/Flashing.md)
