...
PwmFrequency<a class="cmnd" id="pwmfrequency"></a>|`1` = reset PWM frequency to 223Hz<BR>`100..4000` = set PWM frequency (100Hz to 4kHz)<BR>_As of v8.3.0 the default frequency changed to 977Hz
