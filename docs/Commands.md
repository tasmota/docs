...
Br<a class="cmnd" id="br"></a>|Execute a snippet of Berry code, in the global context. Result will be returned in the command response. `Br import math return math.pow(2,2)`
