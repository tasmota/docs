...
SetOption118<a class="cmnd" id="setoption118"></a>|Move ZbReceived from JSON message into the subtopic replacing "SENSOR" default<BR>`0` = disabled *(default)*<BR>`1` = enabled
SetOption119<a class="cmnd" id="setoption119"></a>|Remove device addr from JSON payload<BR>`0` = disabled *(default)*<BR>`1` = enabled
