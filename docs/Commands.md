...
Led<x\><a class="cmnd" id="led"></a>|`#RRGGBB` = set hex color value where `<x>` is the pixel number of the LED<br>. A blank-delimited list of colors sets multiple successive pixels. *(applies only to addressable LEDs)*
