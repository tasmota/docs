...
ZbEndpointTopic<a class="cmnd" id="zbendpointtopic"></a><BR>SetOption120<a class="cmnd" id="setoption120"></a>|Add Zigbee source endpoint as suffix to attributes<BR>`0` = disable _(default)_ <BR>`1` = enable<BR>e.g. `Power3` instead of `Power` if sent from endpoint `3`.
ZbEndpointSuffix<a class="cmnd" id="zbendpointsuffix"></a><BR>SetOption101<a class="cmnd" id="setoption101"></a>|Add the Zigbee endpoint as suffix in topic when using `SetOption89 1`<BR>`0` = disable *(default)*<BR>`1` = enable
