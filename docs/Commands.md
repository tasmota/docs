...
DeviceName<a class="cmnd" id="devicename"></a>|Device name displayed in the webUI and used for HA autodiscovery.`<value>` = set device name _(default = `FriendlyName1` value)
