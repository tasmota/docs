...
Sensor77<a class="cmnd" id="sensor77"></a>|EZOpH sensor - commands<BR>Ascii commands are sent directly to the sensor as-is.  See [EZOpH spec](https://atlas-scientific.com/files/pH_EZO_Datasheet.pdf) for the list of commands available.<BR>If using multiple sensors, they can be addressed individually by issuing the command Sensor77-# where `#` represent the index of the device (ex: Sensor77-1 i)
Sensor78<a class="cmnd" id="sensor78"></a>|EZOORP sensor - commands<BR>Ascii commands are sent directly to the sensor as-is.  See [EZOORP spec](https://atlas-scientific.com/files/ORP_EZO_Datasheet.pdf) for the list of commands available.<BR>If using multiple sensors, they can be addressed individually by issuing the command Sensor78-# where `#` represent the index of the device (ex: Sensor78-1 i)
