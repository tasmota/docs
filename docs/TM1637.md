...
* display **numbers** (both integers and floats) with control over _position_ and _leading zeros_.
* display basic **text**, for example, sending the text `22.5^` displays ![22.5d](_media/peripherals/TM1637-22.5d.jpg)
* display **Raw** segments.
* display _level_, like a **bar graph**
