!!! warning "Most builds will not compile successfully with Arduino IDE anymore"
    Tasmota is now optimised for and built with Visual Studio Code and [PlatformIO](PlatformIO.md). Any error when attempting compiling with Arduino IDE will have to be solved by your and no support will be given.
