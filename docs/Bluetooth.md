...
MI32Unit <a id="mi32unit"></a>|`<n>` = toggle the displayed temperature units of a **LYWSD02 only** sensor. `<n>` is the sensor number in order of discovery starting with 0 (topmost sensor in the webUI list).  Reporting of the temperature always is in Celcius, this only changes the value shown on the device.
...
<table>
  ...
  <tr>
    <td class="tg-lboi"></td>
    <td class="tg-lboi">set time using "MI32Time, units with MI32Unit"</td>
    <td class="tg-lboi"></td>
    <td class="tg-lboi">unsupported time or alarm</td>
    <td class="tg-lboi"></td>
  </tr>
