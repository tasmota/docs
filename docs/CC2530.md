...
<img src="https://github.com/hallard/cc2538-multi-connect/blob/main/pictures/cc2538-enclosure.png?raw=true" alt="With enclosure" height="150">
  ...
  Check the dedicated github [repo](https://github.com/hallard/cc2538-multi-connect) for detailed information
...
Flash the newly compiled binary using the [normal flashing process](Getting-Started.md#flashing).
