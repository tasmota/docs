...
```console
Rule on Tele-APDS9960#Long=1 do power toggle endon on Tele-APDS9960#Up=1 do dimmer + endon on Tele-APDS9960#Down=1 do dimmer - endon on Tele-APDS9960#Left=1 do ct + endon on Tele-APDS9960#Right=1 do ct - endon
```
