If you have read through the [Prerequisites](Prerequisites) you should have selected [a pre-compiled Tasmota firmware binary](Prerequisites#tasmota-firmware-binary) or chosen to [compile your own Tasmota firmware binary](#compiling-from-source).
...
## Need More Help?
If you have encountered problems during flash see the [FAQ](). Ask for help in [Discord](https://discord.gg/Ks2Kzd4) or [Community Forum](https://groups.google.com/d/forum/sonoffusers)
