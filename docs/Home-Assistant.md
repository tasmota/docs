...
!!! failure "Home Assistant support is not built in to tasmota-lite.bin. Use the standard tasmota.bin or other binaries that include Home Assistant support." Check the "Program Version" information in the Information page in the WebUI to validate before you go ahead.
