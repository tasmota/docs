...
![](https://https://tasmota.github.io/docs/_media/deepsleep_minimal.png)
...
![](https://https://tasmota.github.io/docs/_media/deepsleep_gpio16_none.png)
...
- Use a GPIO and connect it GND. This can be performed through a switch like in the schematic below. Flipping the switch ON will prevent Tasmota to enter DeepSleep again after next wake-up until the switch is flipped back OFF.
  ...
  ![](https://https://tasmota.github.io/docs/_media/deepsleep_switch.png)

  You can define the `DeepSleep (182)` component as shown below:

  ![](https://https://tasmota.github.io/docs/_media/deepsleep_deepsleep182.png)
  ...
  ![](https://https://tasmota.github.io/docs/_media/deepsleep_transistor.png)
